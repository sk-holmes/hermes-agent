...
CONFIGURABLE_TOOLSETS = [
    ...
    ("slack_history",   "💬 Slack History",             "read the active channel/thread (read-only)"),
...
_DEFAULT_OFF_TOOLSETS = {"homeassistant", "spotify", "discord", "discord_admin", "slack_history", "video", "video_gen", "x_search"}
